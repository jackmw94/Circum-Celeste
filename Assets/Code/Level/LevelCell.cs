...
namespace Code.Level
{
    public static class LevelCellHelper
    {
        ...
        public static void Initialise(Transform transform, Vector2Int cellCoordinates, float gridSize, float zOffset)
        {
            ...
            cellTransform.localPosition = new Vector3(cellCoordinates.x, cellY, 0f) * size + new Vector3(size / 2f, size / 2f, zOffset);
        }
    }
}